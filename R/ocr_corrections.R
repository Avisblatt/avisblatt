...
correct_ocr <- function(x){
  ...
  x <- gsub("Nachträg","Nachtrag",x)
  x <- gsub("Ausleiben","Ausleihen")
  x <- gsub("Naehtrag","Nachtrag")
  x <- gsub("Merckwürdigkelten","Merckwürdigkeiten")
  x <- gsub("Kaussen","Kauffen")
  x <- gsub("Kaufsen","Kauffen")
  x <- gsub("kausen","kaufen")
  x <- gsub("kaufsen","kaufen")
  x <- gsub("Koft","Kost")
  x <- gsub("Verkoren","Verloren")
  x <- gsub("ant","Gant")
  x <- gsub("Getrante","Getraute")
  x <- gsub("Derloren","Verloren")
  x <- gsub("Perloren","Verloren")
  x <- gsub("Gaut","Gant")
  x <- gsub("Fervanf","Verkauf")
  x <- gsub("eidgenössiche","eidgenössische")
  x <- gsub("Freischiesten","Freischießen")
  x <- gsub("wird zu entlohnen begehrt","wird zu entlehnen begehrt")
  x <- gsub("Nachrichteu","Nachrichten")
  x <- gsub("efundenes","Gefundenes")
  x <- gsub("Gaenten","Ganten")
  x <- gsub("entiehnen","entlehnen")
  x <- gsub("Rachtrag","Nachtrag")
  x <- gsub("Raehtrag","Nachtrag")
  x <- gsub("Veerkauf","Verkauf")
  x <- gsub("Verkäuf","Verkauf")
  x <- gsub("Verlvrenes","Verlorenes")
  x <- gsub("Vierkauf","Verkauf")
  x <- gsub("Vorvanf","Verkauf")
  x <- gsub("wahl","Wahl")
  x <- gsub("Getrante","Getraute")
